...
def create_obsID_write_to_database(config, PID):
    ...
    for i in new_obsids:
        ...
        keys = ('object', 'PID', 'Filter', 'exposure', 'binning', 'airmass', 'moon', 'seeing', 'sky_brightness', 'Observer_type', 'time_sensitive', 'Submission_Date', 'Completed_by', 'total_length','number_of_exposures')
